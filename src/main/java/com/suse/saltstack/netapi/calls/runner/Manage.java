...
public class Manage {
   ...
   public static RunnerCall<List<String>> present(Optional<String> subset, Optional<Boolean> showIpv4) {
      LinkedHashMap<String, Object> args = new LinkedHashMap<>();
      subset.ifPresent(value -> args.put("subset", value));
      showIpv4.ifPresent(value -> args.put("show_ipv4", value));
      return new RunnerCall<>("manage.present", Optional.of(args), new TypeToken<List<String>>(){});
   }
